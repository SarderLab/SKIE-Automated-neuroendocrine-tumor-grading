...
import numpy as np
w = 250 #tile size
def getWindows(source_syn,source_he,pointx,pointy,tform):
    ...
    endx = int(min(1000,source_syn.dimensions[0]-xy_w_o2[0]))
    endy = int(min(1000,source_syn.dimensions[1]-xy_w_o2[1]))
#    
